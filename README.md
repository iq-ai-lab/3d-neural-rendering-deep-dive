...
>
> *로 2D screen 에 projection 되고, **tile-based alpha-compositing** $C = \sum_i \alpha_i T_i c_i,\; T_i = \prod_{j<i}(1-\alpha_j)$ 가 왜 NeRF 의 분 단위 렌더링을 100+ FPS 로 바꾸는지 유도할 수 있는 것은 다르다.*
>
