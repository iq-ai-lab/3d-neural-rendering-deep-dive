...
>
> *로 2D screen 에 projection 되고, **tile-based alpha-compositing** <span>$C = \sum_i \alpha_i T_i c_i,\; T_i = \prod_{j<i}(1-\alpha_j)$</span> 가 왜 NeRF 의 분 단위 렌더링을 100+ FPS 로 바꾸는지 유도할 수 있는 것은 다르다.*
>
...
>
> *NeRF 의 ReLU MLP 가 **positional encoding** <span>$\gamma(p) = (\sin 2^0 \pi p, \cos 2^0 \pi p, \ldots)$</span> 없이는 high-frequency 디테일을 **이론적으로** 학습 못한다는 것 — Rahaman 2019 의 spectral bias, Tancik 2020 의 NTK spectrum — 을 알고 쓰는 것은 다르다.*
