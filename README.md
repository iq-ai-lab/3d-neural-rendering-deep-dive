...
>
> *로 2D screen 에 projection 되고, **tile-based alpha-compositing** $$C = \sum_i \alpha_i T_i c_i, \quad T_i = \prod_{j<i}(1-\alpha_j)$$
...
>
> *NeRF 의 ReLU MLP 가 **positional encoding** $$\gamma(p) = (\sin 2^0 \pi p, \cos 2^0 \pi p, \ldots)$$
